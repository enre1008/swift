...
class ViewController: UIViewController, CAAnimationDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.view.addGestureRecognizer(panGestureRecognizer) //Attaches a gesture recognizer to the view
        createColorSets()
    }
    ...
    func createGradientLayer() {
        ...
        gradientLayer.colors = colorSets[currentColorSet] //设置渐变的主颜色
        self.view.layer.addSublayer(gradientLayer)  //将gradientLayer作为子layer添加到主layer上
    }
    ...
    func changeLabels () {
        ...
        if lastTotalIndex < 12 {
            ...
            temperatureLabel.text = "\(hightestTemprature - lastTotalIndex) ℃"
        }
